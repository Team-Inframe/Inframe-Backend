...
from .views import CustomFrameDetailView, CustomMyFrameDetailView, MySavedFramesView, BookmarkView, CustomFrameCreateView,  CustomFrameListView, CustomFrameHotView
